...
from complete_solutions.exceptions import CalculatorError, DivisionByZeroError, InvalidInputError
from complete_solutions.operations import add, divide, multiply, subtract
